...
void CameraInputListenerSystem::onStart() {
    size_t id=EventBus::getInstance().subscribe("mouse wheeled",[this](std::any param) {
    ...
    id=EventBus::getInstance().subscribe("key w",[this](std::any param) {
    ...
    subscribeIds.push_back(id);
    id=EventBus::getInstance().subscribe("key s",[this](std::any param) {
        assert(ecs::getComponent<TransformComp>(scene,curEntity).has_value());
        auto transformComp = ecs::getComponent<TransformComp>(scene,curEntity).value();
    ...
    subscribeIds.push_back(id);
    id=EventBus::getInstance().subscribe("key a",[this](std::any param) {
        assert(ecs::getComponent<TransformComp>(scene,curEntity).has_value());
        auto transformComp = ecs::getComponent<TransformComp>(scene,curEntity).value();
    ...
    subscribeIds.push_back(id);
    id=EventBus::getInstance().subscribe("key d",[this](std::any param) {
        assert(ecs::getComponent<TransformComp>(scene,curEntity).has_value());
        auto transformComp = ecs::getComponent<TransformComp>(scene,curEntity).value();
    ...
    subscribeIds.push_back(id);
    id=EventBus::getInstance().subscribe("key q",[this](std::any param) {
        auto transformComp = ecs::getComponent<TransformComp>(scene,curEntity).value();
        transformComp.transform.rotation.angle-=10;//逆时针
        ecs::setComponent<TransformComp>(scene,curEntity, transformComp);
    });
    subscribeIds.push_back(id);
    id=EventBus::getInstance().subscribe("key e",[this](std::any param) {
        auto transformComp = ecs::getComponent<TransformComp>(scene,curEntity).value();
