...
size_t EventDispatcher::subscribe(std::string event_name,std::function<void(std::any)>callback,bool isOnce,bool nextFrame) {
...
bool EventDispatcher::unsubscribe(const size_t id) {
